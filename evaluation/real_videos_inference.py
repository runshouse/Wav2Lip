...
parser.add_argument('--min_frame_res', help='Do not downsample further below this frame resolution', default=720)
parser.add_argument('--max_frame_res', help='Downsample to at least this frame resolution', default=1080)
